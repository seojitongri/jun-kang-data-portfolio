...
Aggregated trip data to daily level

Engineered precipitation categories (Dry, Light, Moderate, Heavy, Extreme)

Computed average daily trips by precipitation level

Visualized trends across years

Quantified magnitude of demand change due to rainfall
